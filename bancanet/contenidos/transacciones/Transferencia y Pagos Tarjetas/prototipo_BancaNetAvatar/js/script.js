...
function fondo_demo(){
 ...
 if(location.href.indexOf('htmls_demo')>=0){
            $("#subapp-box .#subapp-box").before('<div class="bg_demo"></div> ');
...
var textos = [	'Realiza compras en el lugar que quieras<br /> y recibe a cambio Puntos Premia.',
				'bg_2<br>bg_2',
				'<span class="color333">Ahorra sin riesgo, pon tu dinero a trabajar<br />con las inversiones a la Vista y administralas<br />desde <strong>Banca</strong>Net</span>',
				'bg_4<br>bg_4'];
				
var links = [	'<img src="../img/flecha_blanca_r.png">&nbsp;&nbsp;<a href="javascript:void(0);">Reglamento Premia Banamex</a>',
				'<img src="../img/flecha_blanca_r.png">&nbsp;&nbsp;bg_2',
				'<img src="../img/flecha_azul_r.gif">&nbsp;&nbsp;<a href="javascript:void(0);" class="color00589d">Conoce los beneficios</a>',
				'<img src="../img/flecha_azul_r.gif">&nbsp;&nbsp;<a href="javascript:void(0);" class="color00589d">bg_4</a>'];
	...
	$('.input_calendar').focus(
		function(){
			if( $(this).hasClass('modal_calendar') ){
				$('.ui-widget').css({'top':($(this).offset().top - $(document).scrollTop() -65)+'px','left':($(this).offset().left+135)+'px', 'z-index':'99999999'});
			}else{
				$('.ui-widget').css({'top':($(this).offset().top-65)+'px','left':($(this).offset().left+135)+'px', 'z-index':'99999999'});
			}
...
function progFecha2(){
	var opFrec = (language == "eng") ? "Yes" : "Si";
	var opFrecno = "No"
  ;
  if($('#guardaOp').is(':checked')) 
