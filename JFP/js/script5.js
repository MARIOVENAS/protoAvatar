...
var fondos = ['bg_0','bg_2','bg_3','bg_4'];

 

var textos = [	'<span class="colorffff f14">Cero anualidad s&iacute; pagas<br />tu tarjeta de cr&eacute;dito<br />por <span class="strong f14">Banca</span>Net</span>',



				'Es momento de empezar<br /> a invertir, h&aacute;zlo f&aacute;cilmente<br /> desde tu <span class="strong f14">Banca</span>Net</span>',

				

				'Descubre todas las <br /> funcionalidades que <br /> te ofrece nuestra app',

				'Con Notificaciones Banamex,<br/> mantente siempre informado<br /> de tus movimientos.'];

				

var links = [	'<img src="../JFP/regional/images/flecha_azul_r.gif">&nbsp;&nbsp;<a href=" http://www.banamex.com/es/personas/landing_tarjetas/index.htm?icid=Menu-TarjetasCredito-Personas-MejoresTarjetas-05152013-Int-ES" class="color00589d">Solic&iacute;tala en l&iacute;nea</a>',

				'<img src="../JFP/regional/images/flecha_azul_r.gif">&nbsp;&nbsp;<a href="http://www.banamex.com/es/personas/inversiones/integral_perfiles.htm" class="color00589d">Conoce nuestras opciones</a>',

				'<img src="../JFP/regional/images/flecha_azul_r.gif">&nbsp;&nbsp;<a href=" http://www.banamex.com/es/personas/servicios/banca_electronica/banamex_movil.htm" class="color00589d">Descargala a tu <br /><span class="margin-left13 f14"> dispositivo</span></a>',

				'<img src="../JFP/regional/images/flecha_azul_r.gif">&nbsp;&nbsp;<a href=" http://www.banamex.com/es/personas/servicios_digitales/notificaciones.htm" class="color00589d">Activalo sin costo</a>'];
...
function cambia_carrusel_DEMO( siguiente ){
	...
	textos[0] = '<span class="colorffff f14">Cero anualidad s&iacute; pagas<br />tu tarjeta de cr&eacute;dito<br />por <span class="strong f14">Banca</span>Net</span>';

	links[0] = '<img src="../JFP/regional/images/flecha_azul_r.gif">&nbsp;&nbsp;<a href=" http://www.banamex.com/es/personas/landing_tarjetas/index.htm?icid=Menu-TarjetasCredito-Personas-MejoresTarjetas-05152013-Int-ES" class="color00589d">Solic&iacute;tala en l&iacute;nea</a>';
...
function fechaHora(){
    ...
    return diaTexto+" "+dia+" de "+mesTexto+" del "+year+", "+hora+":"+minuto+":"+segundo+" ";
...
function tamano3(){
   ...
   $('#contactanos').addClass('arrow').removeClass('arrow2');
		...
		$('.arrow:eq(2)').click(function(event){
