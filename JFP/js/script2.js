...
function funciones_login(){
    ...
    load_html_callback("#navegacionPrincipal2",'piezas/navegacionPrincipal.html',function(){click_topmenu();pop_up('.popup_menu');} ,true)
...
function set_fondoLogin( tipo ){
	...
	var langImg = ( isEnglishSel ) ? 'eng' : 'esp';

	if( tipo == 'demo' ){

		$('#cambiaImagen1').addClass('bg_'+langImg+'2');

		$('#cambiaImagen2').addClass('bg_'+langImg+'0');

	}else{

		$('#cambiaImagen1').addClass('bg_2'+langImg+'');

		$('#cambiaImagen2').addClass('bg_1'+langImg+'');
...
function fondo_demo(){
		 ...
		 var altura_41=$("#subapp-box").height();
...
var fondos = new Array (
               ...
               {esp:'bg_esp0', eng:'bg_eng0'},

			   {esp:'bg_esp1', eng:'bg_eng1'},

			   {esp:'bg_esp2', eng:'bg_eng2'},

			   {esp:'bg_esp3', eng:'bg_eng3'}
...
var textos = new Array(
               ...
               { esp:'<span class="f14" id="t47">Estamos renovando <strong style="font-size: 17px;!important">Banca</strong>Net<br />para mejorar tu experiencia</span></p>', eng:'<span class="f14" id="t47">We are renovating <strong style="font-size: 17px;!important">Banca</strong>Net<br />to improve your experience.</span></p>'},

			   { esp:'<span id="t57" class="f14">Hazlo en s&oacute;lo 3 pasos</span>', eng:'<span id="t57" class="f14">Do it in only 3 steps</span>' },

			   { esp:'<span id="t58" class="f14">Olv&iacute;date de las filas<br />y mejor hazlo con <span class="bold f17">Banca</span>Net</span>', eng:'<span id="t58" class="f14">Forget about lines<br />and do it from <span class="bold f17">Banca</span>Net</span>' },

			   { esp:'<span id="t59" class="colorffff f14">Aprende a realizar transferencias<br />a otras cuentas Banamex<br />y de otros bancos</span>', eng:'<span id="t59" class="colorffff f14">Learn how to make transfers<br />to other Banamex accounts<br />and from other banks</span>' }
...
var links = new Array(
	...
	//{ esp:'',                    eng:'' },Modificado el 29/04/2014
	
	{ esp:'<img src="../JFP/regional/images/flecha_azul_r.gif">&nbsp;&nbsp;<a id="t104" class="color00589d">Comp&aacute;rtenos tu opini&oacute;n</a>',  eng:'<img src="../JFP/regional/images/flecha_azul_r.gif">&nbsp;&nbsp;<a id="t104" class="color00589d">Share your opinion</a>' },
	
	{ esp:'<img src="../JFP/regional/images/flecha_azul_r.gif">&nbsp;&nbsp;<a id="t60" class="color00589d">Conoce c&oacute;mo</a>',  eng:'<img src="../JFP/regional/images/flecha_azul_r.gif">&nbsp;&nbsp;<a id="t60" class="color00589d">Learn how</a>' },

	{ esp:'<img src="../JFP/regional/images/flecha_azul_r.gif">&nbsp;&nbsp;<a id="t61" class="color00589d">Aprende aqu&iacute;</a>', eng:'<img src="../JFP/regional/images/flecha_azul_r.gif">&nbsp;&nbsp;<a id="t61" class="color00589d">Learn here</a>' },

	{ esp:'<img src="../JFP/regional/images/flecha_azul_r.gif">&nbsp;&nbsp;<a id="t62" class="color00589d">Como hacerlo</a>',        eng:'<img src="../JFP/regional/images/flecha_azul_r.gif">&nbsp;&nbsp;<a id="t62" class="color00589d">Learn how</a>' }
...
var hrefLinks = new Array(

	{
		...
		esp:'http://www.banamex.com/es/personas/',

		eng:'http://www.banamex.com/en/personas/'
...

	{
		...
		eng:'http://www.banamex.com/es/personas/'
...
function cambia_carrusel( siguiente ){
	...
	if( fondo_sig==0 ) {
		...
		//$('#texto_bg .link').hide(); Modificado el 29/04/2014
		$('#texto_bg .link').html( links[fondo_sig][language] );
		$('#texto_bg .link a').attr( 'href', hrefLinks[fondo_sig][language] );
		$('#texto_bg .link').show();
...
function cambia_carrusel_DEMO( siguiente ){
	...
	textos[0] [language] = '<span class="colorffff f14">Cero anualidad s&iacute; pagas<br />tu tarjeta de cr&eacute;dito<br />por <span class="strong f14">Banca</span>Net</span>';

	links[0][language] = '<img src="../JFP/regional/images/flecha_azul_r.gif">&nbsp;&nbsp;<a href=" http://www.banamex.com/es/personas/landing_tarjetas/index.htm?icid=Menu-TarjetasCredito-Personas-MejoresTarjetas-05152013-Int-ES" class="color00589d">Solic&iacute;tala en l&iacute;nea</a>';
...
function activarModalInactividad(){
        ...
        load_html_callback("#ContenedorModal",'piezas/modal/modal_sesion_por_finalizar.html',function(){
                ...
                cronometroMinutos('terminar',60*2-1,'#minutosRestantes',function(){
                    ...
                    window.location.href="../../htmls/01-Log-in.html?mod=log";
                                   ...
                                   $.doTimeout(espera+300, function(){ 
                                          ...
                                          $.doTimeout(espera+600, function(){
                                            ...
                                            //$("#cambioPasswordAceptar").addClass("hover")
											 ...
											 $("#cambioPasswordAceptar2").click(function(){location.href='../bancanet_demo/contenidos/26-AccountSummary.html'});
...
function prototipoLogin(){
   ...
   /*$('#salir').live('click',function(event){
    ...
    $.doTimeout(espera, function(){  // llenado en 01-Log-in.html
	 ...
	 /**Ingles**/
	 if(location.href.indexOf('01-Log-in_en.html')!=-1 || location.href.indexOf('01f-Log-in-AhnLab-NotActivated.html')!=-1 || location.href.indexOf('01e-Log-in-AhnLab-NotInstalled.html')!=-1 )  
    ...
    $.doTimeout(espera, function(){  // llenado en 01-Log-in.html
	 ...
	 /**Ingles***/
	  ...
	  if(location.href.indexOf('01-Log-in2.html')!=-1 || location.href.indexOf('01f-Log-in-AhnLab-NotActivated.html')!=-1 || location.href.indexOf('01e-Log-in-AhnLab-NotInstalled.html')!=-1 )  
    ...
    $.doTimeout(espera, function(){  // llenado en 10-Log-in-CambioClaves.html
                                   ...
                                   $.doTimeout(espera+400, function(){ 
                                          ...
                                          $.doTimeout(espera+600, function(){
                                            ...
                                            //$("#cambioPasswordAceptar").addClass("hover")
											 ...
											 $("#cambioPasswordAceptar").click(function(){location.href='../bancanet_demo/contenidos/26-AccountSummary.html'});
     ...
     if(location.href.indexOf('16b-Log-in-CambioClaves-Dentro-Correcta.html')!=-1){
       ...
       // $("#cambioClavesDentroContinuar").click(function(){location.href='26-AccountSummary.html'});
		...
		$("#cambioClavesDentroContinuar").click(function(){location.href='../bancanet_demo/contenidos/26-AccountSummary.html'});
	...
	switch (valor_select){
		...
		case 'rango':
			...
			if( ( $('.calendario1').val() == '' ) && ( $('.calendario2').val() == '' ) ){
				...
				$('.calendario2, .calendario1').addClass("revisar2")
		...
		case 'movimiento':
			...
			if( $('.calendario1').val() == '' && $('.input_num_auto').val() == '' ){
				...
				$('.calendario1, .input_num_auto').addClass("revisar2")
...
function valida_busqueda_onblur(){
	...
	if( ( $('.calendario2').val() != '') ){
		...
		$('#busqueda_to').removeClass("revisar2");
...
function validador_filtrar(){
	...
	if( $('.radio_rango').attr('checked') == 'checked' ){
		...
		if( $('.text_importe1').val() == '' && $('.text_importe2').val() == '' ){
			...
			$('.text_importe1, .text_importe2').addClass("revisar2")
...
function valida_filtro_onblur(){
	...
	if( $('.text_importe1').val() != '' && $('.text_importe2').hasClass("revisar2") ){
...
function datepicker_busqueda_filtro(){
	...
	var dates = $( "#busqueda_from" ).datepicker({
		...
		onClose:function(){
			...
			if ( $("#busqueda_from").val() == '' ) {
				...
				$("#busqueda_to").datepicker('disable');
...
function tamano1(){
	...
	$('#iframeConte').removeClass('ancho692').addClass('ancho765');

	$('#iframeConte').removeClass('alto490').addClass('altoAuto');
...
function tamano2(){
	...
	$('#iframeConte').removeClass('altoAuto').addClass('alto490');
...
function validarlog3(){

		if(document.getElementById('numCliente').value!=""){

			

	window.location.href="../htmls/01-Log-in2.html";
		...
		function validarlog4(){

		if(document.getElementById('claveAcceso').value!=""){

			

	window.location.href="../htmls/06-Log-in-Contrato.html";
...
//Funciones & Links seción Conoce todos los beneficios.

function f1_es(){
	window.open("http://www.banamex.com/es/personas/servicios/banca_electronica/bancanet.htm?icid=BN-SERBNET2-FOO-CanalesAlternos-10072013-INT-ES","","width=1024,height=760,scrollbars=yes");
  }
  function f1_en(){
	window.open("http://www.banamex.com/en/personas/servicios/banca_electronica/bancanet.htm?icid=BN-SERBNET2-FOO-CanalesAlternos-10072013-INT-ES","","width=1024,height=760,scrollbars=yes");
  }
  function f2_es(){
	window.open("http://www.banamex.com/es/personas/servicios/banca_electronica/banamex_movil.htm?icid=BN-SERAPPBP-FOO-CanalesAlternos-10072013-INT-ES","","width=1024,height=760,scrollbars=yes");
  }
  function f2_en(){
	window.open(" http://www.banamex.com/en/personas/servicios/banca_electronica/banamex_movil.htm?icid=BN-SERAPPBP-FOO-CanalesAlternos-10072013-INT-ES","","width=1024,height=760,scrollbars=yes");
  }
  function f3_es(){
	window.open("http://www.banamex.com/estadodecuenta/?icid=BN-SERESTAD-FOO-CanalesAlternos-10072013-INT-ES","","width=1024,height=760,scrollbars=yes");
  }
  function f3_en(){
	window.open("http://www.banamex.com/en/personas/servicios_digitales/estado_cuenta_electronico.htm?icid=BN-SERESTAD-FOO-CanalesAlternos-10072013-INT-EN","","width=1024,height=760,scrollbars=yes");
  }
  function f4_es(){
	window.open("http://www.banamex.com/es/personas/servicios_digitales/notificaciones.htm?icid=BN-SERALERT-FOO-CanalesAlternos-10072013-INT-ES","","width=1024,height=760,scrollbars=yes");
  }
  function f4_en(){
	window.open("http://www.banamex.com/en/personas/servicios_digitales/notificaciones.htm?icid=BN-SERALERT-FOO-CanalesAlternos-10072013-INT-ES","","width=1024,height=760,scrollbars=yes");
  }
  function f5_es(){
	window.open("http://www.banamex.com/es/personas/servicios/audiomatico.htm?icid=BN-SERAUDIO-FOO-CanalesAlternos-10072013-INT-ES","","width=1024,height=760,scrollbars=yes");
  }
  function f5_en(){
	window.open("http://www.banamex.com/en/personas/servicios/audiomatico.htm?icid=BN-SERAUDIO-FOO-CanalesAlternos-10072013-INT-ES","","width=1024,height=760,scrollbars=yes");
  }
  function f6_es(){
	window.open("http://www.banamex.com/es/personas/servicios/cajero_automatico.htm?icid=BN-SERATMSR-FOO-CanalesAlternos-10072013-INT-ES","","width=1024,height=760,scrollbars=yes");
  }
  function f6_en(){
	window.open("http://www.banamex.com/en/personas/servicios/cajero_automatico.htm?icid=BN-SERATMSR-FOO-CanalesAlternos-10072013-INT-ES","","width=1024,height=760,scrollbars=yes");
  }
  function f7_es(){
	window.open("http://www.banamex.com/es/empresas_corporativos/servicios/banca_electronica/bancanet_empresarial.htm?icid=BN-SERBNESS-FOO-CanalesAlternos-10072013-INT-ES","","width=1024,height=760,scrollbars=yes");
  }
  function f7_en(){
	window.open("http://www.banamex.com/en/empresas_corporativos/servicios/banca_electronica/bancanet_empresarial.htm?icid=BN-SERBNESS-FOO-CanalesAlternos-10072013-INT-ES","","width=1024,height=760,scrollbars=yes");
  }
// Link Ver más (see more)

function linkSee(){
	openWindow(rutaAyudaSee,'','','','')
