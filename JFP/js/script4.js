...
var textos = [	'Realiza compras en el lugar que quieras<br /> y recibe a cambio Puntos Premia.',

				'bg_2<br>bg_2',

				'<span class="color333 f14">Ahorra sin riesgo, pon tu dinero a trabajar<br />con las inversiones a la Vista y administralas<br />desde <span class="strong f14">Banca</span>Net</span>',

				'bg_4<br>bg_4'];

				

var links = [	'<img src="../JFP/regional/images/flecha_blanca_r.png">&nbsp;&nbsp;<a href="javascript:void(0);">Reglamento Premia Banamex</a>',

				'<img src="../JFP/regional/images/flecha_blanca_r.png">&nbsp;&nbsp;bg_2',

				'<img src="../JFP/regional/images/flecha_azul_r.gif">&nbsp;&nbsp;<a href="javascript:void(0);" class="color00589d">Conoce los beneficios</a>',

				'<img src="../JFP/regional/images/flecha_azul_r.gif">&nbsp;&nbsp;<a href="javascript:void(0);" class="color00589d">bg_4</a>'];
                                   ...
                                   $.doTimeout(espera+300, function(){ 
                                          ...
                                          $.doTimeout(espera+600, function(){
                                            ...
                                            //$("#cambioPasswordAceptar").addClass("hover")
											 ...
											 $("#cambioPasswordAceptar2").click(function(){location.href='../bancanet_demo/contenidos/48-dashboard-extended.html'});
