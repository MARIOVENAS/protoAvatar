...
function validador_filtrar(){
	...
	if( $('.radio_rango').attr('checked') == 'checked' ){
		...
		if( $('.text_importe1').val() == '' && $('.text_importe2').val() == '' ){
			...
			$('.text_importe1').addClass("revisar2");
...
$(".cal_icon3").click(function(){
		...
		$('.text_importe1').removeClass('revisar2');

		$('#error_filtro_importe2').hide();

		$('.text_importe2').removeClass('revisar2');
...
function tamano1(){
	...
	$('#iframeConte').removeClass('alto490').removeClass('alto520').addClass('altoAuto');
...
function tamano2(){
	...
	$('#iframeConte').removeClass('altoAuto').removeClass('alto520').addClass('alto490');
...
function tamano4(){
	...
	$('#iframeConte').removeClass('altoAuto').removeClass('alto490').addClass('alto520');
